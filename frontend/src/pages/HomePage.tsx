...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#061A17] text-[#F8F5F3] selection:bg-[#A7F3D0] selection:text-[#0B2925] font-sans">
      {/* ========================================================================= */}
      {/* 1. PUBLIC NAVBAR                                                          */}
      {/* ========================================================================= */}
      <nav className="w-full bg-[#061A17]/90 backdrop-blur-md border-b border-[#133D37] sticky top-0 z-50 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-18 flex items-center justify-between">
          {/* Brand Logo */}
          <Link to="/" className="flex items-center gap-3 group select-none cursor-pointer">
            <div className="w-10 h-10 rounded-xl bg-[#0B2925] border border-[#A7F3D0]/40 flex items-center justify-center text-[#A7F3D0] group-hover:bg-[#A7F3D0] group-hover:text-[#0B2925] transition-all duration-200 shadow-md">
              <Shield className="w-5 h-5 transition-transform group-hover:scale-110" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-base tracking-tight text-[#F8F5F3] group-hover:text-[#A7F3D0] transition-colors">
                  Case Examination Registry
                </span>
                <span className="text-[10px] font-mono font-bold text-[#0B2925] bg-[#A7F3D0] px-2 py-0.5 rounded shadow-xs">
                  SIH26188
                </span>
              </div>
              <p className="text-[11px] text-[#A7F3D0]/70 font-sans tracking-wide">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="hidden sm:inline-flex items-center justify-center text-sm font-medium text-[#F8F5F3] hover:text-[#A7F3D0] px-4 py-2 rounded-lg border border-[#133D37] hover:border-[#A7F3D0]/40 hover:bg-[#0B2925] transition-all"
            >
              Sign In
            </Link>
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 text-sm font-semibold bg-[#A7F3D0] hover:bg-[#A7F3D0]/90 text-[#0B2925] px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all active:scale-95"
            >
      ...
      {/* 2. HERO SECTION                                                           */}
      {/* ========================================================================= */}
      <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 border-b border-[#133D37]">
        {/* Subtle Background Glows */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[350px] bg-[#0B2925]/70 blur-[130px] -z-10 rounded-full pointer-events-none" />
        <div className="absolute top-10 right-10 w-[300px] h-[300px] bg-[#A7F3D0]/5 blur-[100px] -z-10 rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#0B2925] border border-[#A7F3D0]/30 text-xs font-mono text-[#A7F3D0]">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#A7F3D0] text-[#0B2925] font-bold text-base hover:bg-[#86efac] shadow-lg shadow-[#A7F3D0]/10 transition-all active:scale-98"
                >
                ...
                <Link
                  to="/login"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#0B2925] hover:bg-[#133D37] text-[#F8F5F3] font-medium text-base border border-[#133D37] hover:border-[#A7F3D0]/40 transition-all"
                >
              ...
              <div className="pt-6 border-t border-[#133D37]/80 grid grid-cols-3 gap-4">
                <div>
                  <div className="text-2xl font-bold font-mono text-[#A7F3D0]">5-Gate</div>
                  <div className="text-xs text-[#F8F5F3]/60 mt-0.5">Forensic Pipeline</div>
                </div>
                <div>
                  <div className="text-2xl font-bold font-mono text-[#A7F3D0]">Sub-Sec</div>
                  <div className="text-xs text-[#F8F5F3]/60 mt-0.5">Automated Verdict</div>
                </div>
                <div>
                  <div className="text-2xl font-bold font-mono text-[#A7F3D0]">0 Cloud</div>
      ...
      {/* ========================================================================= */}
      <section id="capabilities" className="py-20 bg-[#061A17] border-b border-[#133D37]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl bg-[#0B2925] border border-[#133D37] p-6 hover:border-[#A7F3D0]/40 transition-all duration-200 group">
              ...
              <p className="text-sm text-[#F8F5F3]/70 leading-relaxed mb-4">
                128-dimensional facial embedding generation cross-matched between the photo cropped from the physical ID
