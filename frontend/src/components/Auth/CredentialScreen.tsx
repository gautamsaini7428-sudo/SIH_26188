      ...
      <div className="max-w-6xl w-full mx-auto space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold text-[#0B2925]">
              Sign in
            </span>
            <ThemeToggle />
          </div>
        ...
        {/* ── CARD ── */}
        <div
          className="w-full rounded-[28px] overflow-hidden border border-[#E5DDD8] shadow-lg flex flex-col md:flex-row items-stretch bg-white"
        ...
        >
          ...
          {/* Right Panel */}
          <div className="flex-1 p-6 sm:p-10 lg:p-12 flex flex-col justify-center bg-[#FFFFFF]">
            <div className="max-w-md w-full mx-auto space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center gap-2 mb-1.5">
                  <div
                    ...
                    style={{ backgroundColor: meta.chipBg, border: `1px solid ${meta.chipText}22` }}
                  >
                  ...
                  <span className="text-xs text-[#755B73]">
                    {meta.description}
                  </span>
                </div>

                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#27212B]">
                  {role === 'OFFICER' ? 'Officer sign-in' : 'Supervisor sign-in'}
                </h2>
                <p className="text-xs sm:text-sm text-[#59535E]">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1.5">
                  <Zap className="w-3 h-3 text-[#755B73]" />
                  <span className="text-[11px] font-semibold text-[#755B73] uppercase tracking-widest">
                    Quick sign-in
                  </span>
                </div>
                <div className="flex flex-col gap-2">
                  {quickCreds.map((cred) => (
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl border transition-all cursor-pointer text-left group"
                      style={{
                        backgroundColor: activeQuick === cred.email ? meta.chipBg : '#F8F5F3',
                        borderColor: activeQuick === cred.email ? meta.chipText + '44' : '#E5DDD8',
                        opacity: loading && activeQuick !== cred.email ? 0.5 : 1,
                      }}
                    >
                      <div>
                        <p className="text-xs font-semibold text-[#27212B] group-hover:text-[#0B2925]">
                          {cred.label}
                        </p>
                        <p className="text-[10px] text-[#755B73] font-mono mt-0.5">
                          {cred.email}
                        </p>
                      </div>
                      <span
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] text-[#755B73] font-medium">or enter manually</span>
                <div className="flex-1 h-px bg-[#E5DDD8]" />
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5">
                <div className="space-y-1">
                  <label
                    className="text-xs sm:text-sm font-semibold text-[#27212B]"
                    htmlFor="cred-email"
                  >
                    Official Email
                  </label>
                  <div className="relative">
                    <Mail
                      className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-[#755B73]"
                    />
                    <Input
                      id="cred-email"
                      type="email"
              ...
              {/* Footer */}
              <p className="text-[11px] text-center text-[#755B73] pt-1">
